                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Data Masuk:</h6>
                            <a class="collapse-item" href="{{ route('barang.index') }}">
        ...
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    ...
                    // Assuming you have a controller that provides the necessary data
                    $totalCount = Kategori::count(); // Get the total count of records
                    ?>
                    <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                            <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $totalCount }}</div>
                        </div>
                    </div>
                </div>
                <div class="col-auto">
        ...
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    ...
                    // Assuming you have a controller that provides the necessary data
                    $totalCount = Barang::count(); // Get the total count of records
                    ?>
                    <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                            <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $totalCount }}</div>
        ...
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    ...
                    // Assuming you have a controller that provides the necessary data
                    $totalCount = BarangMasuk::count(); // Get the total count of records
                    ?>
                    <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                            <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $totalCount }}</div>
        ...
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    ...
                    // Assuming you have a controller that provides the necessary data
                    $totalCount = Barangkeluar::count(); // Get the total count of records
                    ?>
                    <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                            <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $totalCount }}</div>
